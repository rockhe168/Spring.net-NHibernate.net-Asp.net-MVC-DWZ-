...
function initEnv() {
    ...
    $("#leftside").jBar({ minW: 120, maxW: 700 });
...
function initUI(_box) {
    ...
    if ($.fn.dwzJftExport) $("a[target=dwzJftExport]", $p).dwzJftExport();
    ...
    $.fn.navMenu = function () {
        return this.each(function () {
            ...
            $box.find("li>a").click(function () {
                ...
                /*hxh   xsg  修改于 2012-05-30*/
                $.post("LeftSide.aspx?key=" + $a.attr("href") + "", {}, function (html) {
...
iframe.src == "javascript:'<html></html>';") {
        ...
        if (doc.XMLDocument) {
            ...
            try {
                //response = $iframe.contents().find("body").html();   hxh 修改于2012-05-18
                response = $iframe.contents().find("body").html().replace("<PRE>", "").replace("</PRE>", "");
...
function navTabAjaxDone(json) {
    ...
    if (json.statusCode == DWZ.statusCode.ok) {
        if (json.navTabId) {
            ...
            /*xsg 修改于2012-08-14*/
            if ("closeCurrentNotLoad" != json.callbackType) {
        ...
        else if ("closeCurrentNotLoad" == json.callbackType) {
            /*xsg 修改于2012-08-14*/
        }
        else {
