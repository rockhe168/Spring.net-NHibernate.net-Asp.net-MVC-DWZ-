<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfoList.aspx.cs" Inherits="Web.Programs.SystemManager.UserInfoList" %>
...
<form id="pagerForm" method="post" action="Programs/SystemManager/UserInfoList.aspx">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="Programs/SystemManager/UserInfoList.aspx" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li <%=CheckFunOutDisplay(FunType.Add) %>><a class="add" href="#" onclick="OpenDialogWindow('Programs/SystemManager/UserInfoAdd.aspx','UserInfoAdd','新增')"><span>添加</span></a></li>
			<li <%=CheckFunOutDisplay(FunType.Delete) %>><a class="delete" href="#" onclick="OpenAlertWindowTodoDelete('Ajax/SystemManager/UserInfoService.ashx?action=Delete','UserID','确认要删除此记录吗！')"><span>删除</span></a></li>
		</ul>
	</div>
...
<%=model.UserEmail %>
                            ...
                            <label><a title="修改" href="#"  class="btnEdit" onclick="OpenDialogWindowTodoEditByPK('Programs/SystemManager/UserInfoEdit.aspx','UserInfoEdit','修改','UserID')"></a></label>
                        </td>
			            </tr>
                  <%
                }
